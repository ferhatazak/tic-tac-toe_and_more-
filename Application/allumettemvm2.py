...
def choixdifficulte() -> int :
    """
    fonction qui permet a l'utilisateur de choisir un niveau de difficulté aux machines.
    Entrée : rien 
    Sortie : un entier correspondant a l'un des choix 
    """
    choix : int 
    
    print("Veuiller choisir le niveau de difficulté de la machine")
    print("1 - niveau debutant")
    print("2 - niveau avancé")
    print()
    choix = int(input("--->"))
    return choix
...
def principalallumettesmvm()->list[list[str]]: #humain contre humain 
