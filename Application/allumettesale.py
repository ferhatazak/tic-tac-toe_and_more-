...
def principalallumettesaleatoire()->list[list[str]]: #humain contre humain 
    ...
    while nballumettes!=1 and perdu==False:
        ...
        if nballumettes==0:
            ...
            if choix_commence == 1:
                ...
                print()
                affinput=str(joueur1)+", entrez le nombre d'allumettes à enlever :"
...
if __name__=="__main__":
    print(principalallumettesaleatoire())